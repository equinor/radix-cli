...
func scaleComponent(apiClient *radixapi.Radixapi, appName, envName, cmpName, replicas string) error {
...
func resetScaledComponent(apiClient *radixapi.Radixapi, appName, envName, cmpName string) error {
