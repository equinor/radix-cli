...
func init() {
	...
	logsEnvironmentComponentCmd.Flags().DurationP(flagnames.Since, "s", 0, "Only return logs newer than a relative duration, eg. 5m or 12h. Defaults to showing all logs when --previous is set")
