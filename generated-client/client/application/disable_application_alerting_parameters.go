...
// bindParamDisableApplicationAlerting binds the parameter Impersonate-Group
func (o *DisableApplicationAlertingParams) bindParamImpersonateGroup(formats strfmt.Registry) []string {
