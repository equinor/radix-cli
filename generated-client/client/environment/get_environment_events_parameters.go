...
// bindParamGetEnvironmentEvents binds the parameter Impersonate-Group
func (o *GetEnvironmentEventsParams) bindParamImpersonateGroup(formats strfmt.Registry) []string {
