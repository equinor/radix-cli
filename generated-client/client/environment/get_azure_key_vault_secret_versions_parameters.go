...
// bindParamGetAzureKeyVaultSecretVersions binds the parameter Impersonate-Group
func (o *GetAzureKeyVaultSecretVersionsParams) bindParamImpersonateGroup(formats strfmt.Registry) []string {
