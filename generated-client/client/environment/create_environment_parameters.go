...
// bindParamCreateEnvironment binds the parameter Impersonate-Group
func (o *CreateEnvironmentParams) bindParamImpersonateGroup(formats strfmt.Registry) []string {
