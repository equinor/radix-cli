...
func (o *RerunApplicationJobReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /applications/{appName}/jobs/{jobName}/restart] rerunApplicationJob", response, response.Code())
	}
}
...
func (o *RerunApplicationJobNoContent) Error() string {
	return fmt.Sprintf("[POST /applications/{appName}/jobs/{jobName}/restart][%d] rerunApplicationJobNoContent ", 204)
}
...
func (o *RerunApplicationJobUnauthorized) Error() string {
	return fmt.Sprintf("[POST /applications/{appName}/jobs/{jobName}/restart][%d] rerunApplicationJobUnauthorized ", 401)
}
...
func (o *RerunApplicationJobNotFound) Error() string {
	return fmt.Sprintf("[POST /applications/{appName}/jobs/{jobName}/restart][%d] rerunApplicationJobNotFound ", 404)
}
