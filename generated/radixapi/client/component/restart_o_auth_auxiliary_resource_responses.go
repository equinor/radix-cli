...
func (o *RestartOAuthAuxiliaryResourceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /applications/{appName}/environments/{envName}/components/{componentName}/aux/{type}/restart] restartOAuthAuxiliaryResource", response, response.Code())
	}
}
...
func (o *RestartOAuthAuxiliaryResourceOK) Error() string {
	return fmt.Sprintf("[POST /applications/{appName}/environments/{envName}/components/{componentName}/aux/{type}/restart][%d] restartOAuthAuxiliaryResourceOK", 200)
}
...
func (o *RestartOAuthAuxiliaryResourceUnauthorized) Error() string {
	return fmt.Sprintf("[POST /applications/{appName}/environments/{envName}/components/{componentName}/aux/{type}/restart][%d] restartOAuthAuxiliaryResourceUnauthorized", 401)
}
...
func (o *RestartOAuthAuxiliaryResourceForbidden) Error() string {
	return fmt.Sprintf("[POST /applications/{appName}/environments/{envName}/components/{componentName}/aux/{type}/restart][%d] restartOAuthAuxiliaryResourceForbidden", 403)
}
...
func (o *RestartOAuthAuxiliaryResourceNotFound) Error() string {
	return fmt.Sprintf("[POST /applications/{appName}/environments/{envName}/components/{componentName}/aux/{type}/restart][%d] restartOAuthAuxiliaryResourceNotFound", 404)
}
...
func (o *RestartOAuthAuxiliaryResourceConflict) Error() string {
	return fmt.Sprintf("[POST /applications/{appName}/environments/{envName}/components/{componentName}/aux/{type}/restart][%d] restartOAuthAuxiliaryResourceConflict", 409)
}
...
func (o *RestartOAuthAuxiliaryResourceInternalServerError) Error() string {
	return fmt.Sprintf("[POST /applications/{appName}/environments/{envName}/components/{componentName}/aux/{type}/restart][%d] restartOAuthAuxiliaryResourceInternalServerError", 500)
}
