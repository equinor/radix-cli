...
func (a *Client) HandleGithubWebhook(params *HandleGithubWebhookParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*HandleGithubWebhookOK, error) {
	...
	if params == nil {
		params = NewHandleGithubWebhookParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "handleGithubWebhook",
		Method:             "POST",
		PathPattern:        "/webhooks/github",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http", "https"},
		Params:             params,
		Reader:             &HandleGithubWebhookReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*HandleGithubWebhookOK)
	if ok {
		return success, nil
	}
	...
	msg := fmt.Sprintf("unexpected success response for handleGithubWebhook: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
